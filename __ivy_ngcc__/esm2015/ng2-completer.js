 ...
 * MIT license
 */
import { EventEmitter, Injectable, Directive, Output, Host, ElementRef, NgZone, HostListener, Input, TemplateRef, ViewContainerRef, ChangeDetectorRef, Renderer2, Component, forwardRef, ViewChild, NgModule } from '@angular/core';
...
CompleterService.ɵfac = function CompleterService_Factory(t) { return new (t || CompleterService)(ɵngcc0.ɵɵinject(LocalDataFactory), ɵngcc0.ɵɵinject(RemoteDataFactory)); };
...
CompleterCmp.propDecorators = {
    ...
    keyup: [{ type: Output }],
    keydown: [{ type: Output }],
    completer: [{ type: ViewChild, args: [CtrCompleter, { static: false },] }],
    ctrInput: [{ type: ViewChild, args: ["ctrInput", { static: false },] }],
